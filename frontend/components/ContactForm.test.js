...
userEvent.type(firstNameField, 'walyn');
...
userEvent.type(emailField, 'walyn@gmail');
...
userEvent.type(firstNameField, 'walyn');
userEvent.type(lastNameField, 'smith');
userEvent.type(emailField, 'walyn@gmail.com');

const button = screen.getByRole('button');
userEvent.click(button);

await waitFor(() => {
    const firstnameDisplay = screen.queryByText('walyn');
    const lastnameDisplay = screen.queryByText('smith');
    const emailDisplay = screen.queryByText('walyn@gmail.com');
